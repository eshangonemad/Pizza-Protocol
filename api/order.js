...
async function generateOrderEmail(items) {
  ...
  const itemsHtml = items.map(item => {
    ...
    return `
      ...
      <tr>
        ...
        <td style="padding: 10px; border-bottom: 1px solid #ddd;">âˆ°${pizza.price.toFixed(2)}</td>

        <td style="padding: 10px; border-bottom: 1px solid #ddd;">âˆ°${itemTotal.toFixed(2)}</td>
  ...
  return `
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <h1 style="text-align: center; color: #333;">ðŸ• Your Virtual Pizza Order</h1>
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 10px; font-weight: bold;">âˆ°${orderTotal.toFixed(2)}</td>
      ...
      <p style="text-align: center; color: #666;">
        ...
        Enjoy your virtual pizzas! They're calorie-free! ðŸŽ‰
...
app.post('/api/order', async (req, res) => {
  ...
  try {
    ...
    await transport.sendMail({
      ...
      from: '"Virtual Pizza ðŸ•" <pizza@pizzaprotocol.xyz>',

      to: email,

      subject: "Your Virtual Pizza Order Has Arrived! ðŸ•",
    ...
    res.json({ 
      ...
      message: "Virtual pizzas sent! Check your email ðŸ“§" 
